        ...
        <div className="max-w-7xl mx-auto px-6 py-8">
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-purple-100 text-base">View and manage all turf events</p>
            </div>
            <button
              onClick={() => router.back()}
          ...
          <div className="grid grid-cols-1 gap-6">
            {filteredEvents.map((event) => {
              ...
              return (
                <div
                  key={event.id}
                  className="bg-white rounded-xl shadow-lg border-l-4 border-purple-600 p-6 hover:shadow-xl transition"
                >
                  ...
                  <div className="bg-gray-50 rounded-lg p-4 mb-4">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
                      <div>
                        ...
                        <p className="text-xl font-bold text-purple-600">{event.participantCount}</p>
                      </div>
                      <div>
                  ...
                  <div className="flex flex-wrap gap-3">
                    ...
                    <button onClick={() => viewParticipants(event.id)} className="px-4 py-2 bg-purple-600 text-white font-semibold rounded-lg hover:bg-purple-700 transition">
                      👥 View Participants
                    </button>
                    {event.status === 'closed' && (
                      <button onClick={() => router.push(`/secretary/add-players/${event.id}`)} className="px-4 py-2 bg-orange-600 text-white font-semibold rounded-lg hover:bg-orange-700 transition">
                        ➕ Add Players
                      </button>
                    )}
                  </div>
          ...
          <div className="bg-white rounded-xl shadow-2xl max-w-2xl w-full p-8">
            ...
            <form onSubmit={handleEdit} className="space-y-6">
              ...
              <div className="flex gap-4">
                <button type="submit" className="flex-1 px-6 py-3 bg-purple-600 text-white font-bold rounded-lg hover:bg-purple-700 transition">
                  ✓ Save Changes
                </button>
